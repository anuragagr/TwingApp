...
//            
//            NSDictionary* rectangle2FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"HelveticaNeue-Light" size: 30], NSForegroundColorAttributeName: color0, NSParagraphStyleAttributeName: rectangle2Style};
//            
//            [@"Okay!" drawInRect: rectangle2Rect withAttributes: rectangle2FontAttributes];
//
//
...
//            CGContextRestoreGState(context);
    ...
    //// Rectangle 2 Drawing
    CGRect rectangle2Rect = CGRectMake(40, 5, 300, 25);
    NSMutableParagraphStyle* rectangle2Style = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
    rectangle2Style.alignment = NSTextAlignmentCenter;
    
    NSDictionary* rectangle2FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"SFUIText-Regular" size:15.0], NSForegroundColorAttributeName:[UIColor whiteColor]};
    
    [@"back" drawInRect: rectangle2Rect withAttributes: rectangle2FontAttributes];
}
+ (void)drawCameraDoneWithFrame:(CGRect)frame
{
    //// Rectangle 2 Drawing
    CGRect rectangle2Rect = CGRectMake(40, 5, 300, 25);
    NSMutableParagraphStyle* rectangle2Style = NSMutableParagraphStyle.defaultParagraphStyle.mutableCopy;
    ...
    NSDictionary* rectangle2FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"SFUIDisplay-Medium" size: 15.0], NSForegroundColorAttributeName:[UIColor colorWithRed:221/225.0 green:160/255.0 blue:60/255.0 alpha:1.0]};
    
    [@"done" drawInRect: rectangle2Rect withAttributes: rectangle2FontAttributes];
}
